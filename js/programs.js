const programItems = [
    ...
    },
    {
        ...
        "content": "<p>We believe that meaningful advocacy starts with understanding. Through dedicated research and documentation, we capture the real-life experiences of women with disabilities across Kenya. By listening to their voices and documenting their stories, we gain valuable insights that help shape our programs, influence policy, and raise awareness.</p><br> \
        <p>Our work under initiatives such as the <strong>UAF Project</strong> and the <strong>FRIDA Project</strong> focuses on identifying the barriers women with disabilities face in everyday life—from accessing healthcare and education to navigating social stigma and economic exclusion.</p><br> \
        <p>We use a variety of research methods, including interviews, surveys, and community consultations, to ensure that the information we gather is inclusive and representative. This research is transformed into accessible reports, articles, videos, and visual stories that inform the public, challenge stereotypes, and drive positive change.</p><br> \
        <p>We are committed to ensuring that women with disabilities are not just subjects of research—but <strong>active participants</strong>. Many of our projects include community-led documentation efforts, giving women with disabilities the tools and platforms to share their own narratives.</p><br> \
        <p>By turning evidence into action, we help build a stronger, more inclusive society—<strong>one story, one voice at a time</strong>.</p>"
    },
...

    {
        ...
        "content": "<p>We are committed to empowering women with disabilities by equipping them with the knowledge, skills, and confidence they need to lead, advocate, and thrive. Our capacity building and training programs are designed to address key areas such as <strong>leadership development</strong>, <strong>advocacy skills</strong>, <strong>self-care</strong>, <strong>communication</strong>, <strong>rights awareness</strong>, and <strong>economic empowerment</strong>.</p><br> \
        <p>We conduct tailored workshops, mentorship sessions, and peer learning forums that allow women with disabilities to strengthen their personal and professional abilities. These training opportunities not only build self-confidence but also enable participants to take on active roles in their communities, influence local decision-making, and become champions for disability rights.</p><br> \
        <p>In addition to supporting individuals, we also engage with service providers and duty-bearers—including institutions such as the <strong>Judiciary</strong> and the <strong>Prisons Department</strong>—to build their capacity to better serve women with disabilities. Through sensitization sessions and inclusive training modules, we aim to increase awareness of the unique challenges faced by women with disabilities and promote more accessible, respectful, and equitable service delivery.</p><br> \
        <p>By investing in both individuals and institutions, our goal is to create an ecosystem where women with disabilities are supported, recognized, and empowered to live with dignity and independence. Capacity building is not just about acquiring skills—it's about unlocking potential and fostering inclusive environments that leave no one behind.</p>"
    },
    {
        "id": 4,
        ...
        "content": "<p>We believe that meaningful change happens when people and organizations come together around a shared purpose. Through strategic networking and collaboration, we build strong partnerships with <strong>civil society organizations</strong>, <strong>government agencies</strong>, and <strong>individuals</strong> working to advance the rights and wellbeing of women with disabilities.</p><br> \
        <p>These partnerships allow us to pool resources, share knowledge, and coordinate efforts to create a more unified and powerful voice for disability inclusion. Whether it's co-hosting events, contributing to joint advocacy campaigns, or engaging in shared training programs, we work collectively to increase reach and maximize impact.</p><br> \
        <p>We actively engage in multisectoral platforms that address key issues such as <strong>access to justice</strong>, <strong>healthcare</strong>, <strong>education</strong>, <strong>economic empowerment</strong>, and <strong>gender-based violence</strong>. By collaborating across sectors, we help ensure that the specific needs of women with disabilities are considered in broader development agendas.</p><br> \
        <p>In addition to formal partnerships, we also foster informal networks of peer support, community advocates, and allies who contribute to creating inclusive and supportive environments. These networks are essential in sustaining long-term advocacy, amplifying community voices, and building solidarity.</p><br> \
        <p>Our goal is to strengthen the support system around women with disabilities—ensuring they are not only seen and heard but also actively supported by a network of committed stakeholders across society.</p>"
    }


];

const card_contain = document.getElementById('programs-cards');
...
programItems.forEach(item => {
    ...
    col.innerHTML = `
                <div class="custom-block-wrap">
                    ...
                    <a href="programs.html" class="custom-btn btn" onclick="viewNews(${item.id})">Read More</a>
                    </div>
                </div>
                `;

    card_contain.appendChild(col);
});

function viewNews(id) {
    const selectedProgram = programItems.find(item => item.id === id);
